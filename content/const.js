...
const ISKIP_URL_TRACKER = "http://torrents.iteam.net.ua/";
const ISKIP_URL_GAME_WEB = "http://play.iteam.net.ua/";
const ISKIP_URL_FAFA = "http://fafa.iteam.net.ua/";
const ISKIP_URL_IPTV = "http://tv.iteam.net.ua/";
